...
# Test scenario: network1.png : 10 nodes
...
# Test scenario: network3.png : 10 nodes
# RunTest arg_ch=multiatt arg_file=$NW_CONFIG_DIR/network3_att_file.coeff mesh_nw_sim_test \
#                 node_device \
#                 node_device \
#                 node_device \
#                 node_device \
